...
in
{
  ...
  config = lib.mkIf cfg.enable {
	...
	"sk-ssh-ed25519@openssh.com AAAAGnNrLXNzaC1lZDI1NTE5QG9wZW5zc2guY29tAAAAIFQzoOCl3/H1FmfKsJJ72gRq57zf0sV/noJz+rqJeKcRAAAAEXNzaDpqYXlzYS15dWJpa2V5" # jaysa hardware token

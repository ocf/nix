...

{
  ...
  age.secrets =
    ...
    # build age.secrets.${secret} from puppetSecrets
    // (lib.genAttrs puppetSecrets (secret: {
      rekeyFile = ../../secrets/master-keyed/koi/${secret}.pem.age;
      path = "/etc/ocfweb/puppet-certs/${secret}.pem";
      owner = "root";
      mode = "0644";
    }));
